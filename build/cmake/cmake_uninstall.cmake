...
IF(NOT EXISTS "/home/ggory15/git/python_wrapping/build/install_manifest.txt")
  MESSAGE(FATAL_ERROR "Cannot find install manifest:\"/home/ggory15/git/python_wrapping/build/install_manifest.txt\"")
ENDIF(NOT EXISTS "/home/ggory15/git/python_wrapping/build/install_manifest.txt")

MESSAGE(STATUS "catkin path: /devel/.catkin")
IF(EXISTS "/devel/.catkin")
  MESSAGE(STATUS "Try to remove /devel/.catkin")
  EXECUTE_PROCESS(
      COMMAND /usr/bin/cmake -E remove "/devel/.catkin"
      RESULT_VARIABLE rm_resval
      OUTPUT_VARIABLE rm_out
      ERROR_VARIABLE rm_err
       )
ENDIF(EXISTS "/devel/.catkin")


FILE(READ "/home/ggory15/git/python_wrapping/build/install_manifest.txt" files)
